...
class ApplicationSubmissionConfirmationViewSpec extends VatRegViewSpec {
  ...
  object ExpectedContent {
    ...
    val listItem1 = "We’ve received your application and we will write to you with a decision in about 40 days."
    val listItem1Doc = "After we receive copies of your documents, we’ll write to you with a decision on your application in about 40 days."
