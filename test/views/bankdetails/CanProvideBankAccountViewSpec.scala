...
class CanProvideBankAccountViewSpec extends VatRegViewSpec {

  implicit val doc: Document = Jsoup.parse(view(HasCompanyBankAccountForm.form).body)
  lazy val view: CanProvideBankAccountView = app.injector.instanceOf[CanProvideBankAccountView]

  val heading = "Can you provide bank or building society details for VAT repayments to the business?"
  val title = s"$heading - Register for VAT - GOV.UK"
  val para = "If HMRC owes the business money, it will repay this directly to your business’s account."
