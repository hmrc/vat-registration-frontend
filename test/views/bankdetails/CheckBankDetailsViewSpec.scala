...
class CheckBankDetailsViewSpec extends VatRegViewSpec {
  ...
  val title              = "Check your bank account details"
  val heading            = "Check your bank account details"
  ...
  val rollNumberLabel    = "Roll number"
  val p1                 = "By confirming, you are providing your consent for HMRC to verify your bank details with your bank."
  ...
  "CheckBankDetailsView" should {
    ...
    "have a change link" in new ViewSetup {
      doc.select(".govuk-summary-card__action a").text must include(changeLink)
    }
