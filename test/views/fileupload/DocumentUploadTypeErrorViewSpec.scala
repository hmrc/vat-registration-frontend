...
class DocumentUploadTypeErrorViewSpec extends VatRegViewSpec with VatRegistrationFixture {

  val view: UploadDocumentTypeError = app.injector.instanceOf[UploadDocumentTypeError]

  object ExpectedMessages {
    val heading = "We cannot accept the selected file type"
    val title = s"$heading - Register for VAT - GOV.UK"
    val para = "The selected file must be a JPG, BMP, PNG, PDF, DOC, DOCX, XLS, XLSX, GIF or TXT"
