...
class OverseasApplyForEoriViewSpec extends VatRegViewSpec {
  ...
  object ExpectedContent {
    ...
    val bullet1 = "making a customs declaration - check if you’re eligible to make a customs declaration (opens in new tab)"
    val bullet2 = "making an entry summary declaration (opens in new tab)"
    val bullet3 = "making an exit summary declaration (opens in new tab)"
    val bullet4 = "making a temporary storage declaration (opens in new tab)"
    val bullet5 = "making a customs declaration for temporary admission or re-export declaration where you have a guarantee (opens in new tab)"
    ...
    val bullet8 = "established in a common transit country (opens in new tab) where the declaration is lodged instead of an entry summary declaration or is used as a pre-departure declaration"

    val p2 = "If you’re not eligible to apply for an EORI number yourself, you’ll need to appoint someone to deal with customs on your behalf. (opens in new tab) The person you appoint will need to get the EORI number instead of you."
    ...
    val link1Text = "check if you’re eligible to make a customs declaration (opens in new tab)"
    val link2Text = "entry summary declaration (opens in new tab)"
    val link3Text = "exit summary declaration (opens in new tab)"
    val link4Text = "temporary storage declaration (opens in new tab)"
    val link5Text = "customs declaration for temporary admission or re-export declaration where you have a guarantee (opens in new tab)"
    val link6Text = "common transit country (opens in new tab)"
    val link7Text = "appoint someone to deal with customs on your behalf. (opens in new tab)"
