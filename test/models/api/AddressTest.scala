...
class AddressTest extends VatRegSpec {
  ...
  "equals" should {
    "match given same line1 and postcode" in {
      val a1 = Address("1 Address Line", Some("line 2"), None, None, Some("AA1 1AA"), None, addressValidated = true)
      val a2 = Address("1 Address Line", Some("line 2"), None, None, Some("AA1 1AA"), None, addressValidated = true)
      a1 mustBe a2
    }

    "not match given same line1 and different postcode" in {
      val a1 = Address("1 Address Line", Some("line 2"), None, None, Some("AA1 1AA"), None, addressValidated = true)
      val a2 = Address("1 Address Line", Some("line 2"), None, None, Some("AA2 1AA"), None, addressValidated = true)
      a1 must not equal a2
    }

    "not match given different line1 and same postcode" in {
      val a1 = Address("1 Address Line", Some("line 2"), None, None, Some("AA1 1AA"), None, addressValidated = true)
      val a2 = Address("9 Address Line", Some("line 2"), None, None, Some("AA1 1AA"), None, addressValidated = true)
      a1 must not equal a2
    }

    "match given same line1 and country" in {
      val a1 = Address("1 Address Line", Some("line 2"), None, None, None, None, Some(testCountry), addressValidated = true)
      val a2 = Address("1 Address Line", Some("line 2"), None, None, None, None, Some(testCountry), addressValidated = true)
      a1 mustBe a2
    }

    "not match given same line1 and different country" in {
      val a1 = Address("1 Address Line", Some("line 2"), None, None, None, None, Some(testCountry), addressValidated = true)
      val a2 = Address("1 Address Line", Some("line 2"), None, None, None, None, Some(Country(None, Some("Romania"))), addressValidated = true)
      a1 must not equal a2
    }

    "not match given different line1 and same country" in {
      val a1 = Address("1 Address Line", Some("line 2"), None, None, None, None, Some(testCountry), addressValidated = true)
      val a2 = Address("9 Address Line", Some("line 2"), None, None, None, None, Some(testCountry), addressValidated = true)
      a1 must not equal a2
    }
