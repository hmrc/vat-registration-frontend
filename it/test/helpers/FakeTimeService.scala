...
class FakeTimeService @Inject()(bankHolidaysService: BankHolidaysService, servicesConfig: ServicesConfig)
  extends TimeService(bankHolidaysService, servicesConfig) {
