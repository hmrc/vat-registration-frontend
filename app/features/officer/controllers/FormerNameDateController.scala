...
//              } yield Ok(features.officer.views.html.former_name_date(res, formerName))
//            }
//          }
//    }
//
...
//                  .map(formerName => BadRequest(features.officer.views.html.former_name_date(badForm, formerName))),
